        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DPReviewApr.php?viewrequests=<?php echo $ids; ?>">Approved Request Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                            ...
                                            <div style="display: none" id="printablearea2">
                                                    ...
                                                    <div style="text-align: left;">
                                                         ...
                                                         <br>
                                                              ...
                                                              <p style="font-size: 12px">This request is valid until 3 days
                                                               upon approval after which, if items are not picked up, the request is automatically cancelled.</p>
                                                             <p style="font-size: 12px">Supplies and materials will be released only to an authorized personnel of the requesting office.</p>
                                                        </div>
                                                   </div>
                                               </div>
