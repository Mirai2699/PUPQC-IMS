            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    ...
                    <ul class="active">
                        ...
                        <li><a class="active" href="DMAprReq.php">Approved</a></li>    
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMAprReq.php">Approved Requests</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                            ...
                            <div class="col-sm-12">
                                <section class="panel">
                                    <header class="panel-heading" style="background-color: navy; color: white">
                                      Approved Requests of Property and Supply Office
                                    </header>
                                  ...
                                  <div class="panel-body">
                                    ...
                                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                                        ...
                                        <tbody>
                                            <?php
                                                $view_query = mysqli_query($connection,"SELECT * FROM `ims_t_summary_request` WHERE Status_Req = 'APPROVED' ORDER BY Batch_No DESC");
                                            ...
                                            ?>      
                                                     <tr class="gradeX">
                                                            ...
                                                            <td style='width:150px'>
                                                                    ...
                                                                    <a href="DMReviewApr.php?viewrequests=<?php echo $bn; ?>" class="btn btn-success">View</a>               
                                                                    </center>
                                                           </td>
                                                    </tr>  
                            ...
                            <div class="col-sm-12">
                                <section class="panel">
                                    <header class="panel-heading" style="background-color: #00c853; color: white">
                                       Medicinal Supplies Approved Requests 
                                    </header>
                                    ...
                                    <tbody>
                                        <?php 
                                            $view_query = mysqli_query($connection,"SELECT * FROM `ims_t_med_summary_request` 
                                                                                    WHERE Status_Req = 'APPROVED'  ORDER BY Batch_No DESC");
                                                            ...
                                                            if($stat == "APPROVED")
                                                             {
                                                                echo       
                                                                    "<td style='text-align:center'>
                                                                         ...
                                                                         <a href='DM_MEDReviewApr.php?viewrequests=$bn' class='btn btn-success'>Review</a> 
                                                                    </td>";
                                                             }
                                                             else if($stat == "RELEASED")
                                                             {
                                                                echo       
                                                                    "<td style='text-align:center'>
                                                                         ...
                                                                         <a href='DM_MEDReviewApr.php?viewrequests=$bn' class='btn btn-info'>Review</a> 
                                                                    </td>";
                                                             }
                                                             else if($stat == NULL)
                                                             {
                              ...
                              <section class="panel">
                                    <header class="panel-heading" style="background-color: #eeff41; color: black">
                                       Clinical Supplies Approved Requests 
                                    </header>
                                                            ...
                                                            if($stat == "APPROVED")
                                                             {
                                                                echo       
                                                                    "<td style='text-align:center'>
                                                                         ...
                                                                         <a href='DM_CLIReviewApr.php?viewrequests=$bn' class='btn btn-success'>Review</a> 
                                                                    </td>";
                                                             }
                                                             else if($stat == "RELEASED")
                                                             {
                                                                echo       
                                                                    "<td style='text-align:center'>
                                                                         ...
                                                                         <a href='DM_CLIReviewApr.php?viewrequests=$bn' class='btn btn-info'>Review</a> 
                                                                    </td>";
                                                             }
                                                             else if($stat == NULL)
                                                             {
