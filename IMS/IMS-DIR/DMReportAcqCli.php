                   ...
                   <ul class="active" >
                        ...
                        <li><a class="active" href="javascript:;">Acquisition</a>
                           <ul class="active" >
                              ...
                              <li><a class="active" href="DMReportAcqCli.php">Clinical Supplies</a></li>       
                          </ul>
                        </li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMReportAcqCli.php">Procurement of Clinical Supplies Report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                    ...
                    <div class="adv-table">
                        <div class="col-md-12" style="text-align: left">
                             ...
                             <div class="col-md-2"  style="text-align: left; padding-top: 22px">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info" name="FilterCLIAcquisition" style="">Filter</button> 
                         ...
                         <div style="display: none" id="printablearea">
                                ...
                                <div style="margin-top: 10px; margin-left: 15px">
                                    ...
                                    <h5>Table Description:</h5> 
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The table below shows the filtered details of the current medical and clinic items procurement records as of <?php echo date('F d, Y') ?>.
                                        </p>
