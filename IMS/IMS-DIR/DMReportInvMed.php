                   ...
                   <ul class="active" >
                        ...
                        <li><a class="active" href="javascript:;">Inventory Stocks</a>
                           <ul class="active" >
                              ...
                              <li><a class="active" href="DMReportInvMed.php">Medicinal Supplies</a></li> 
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMReportInvMed.php">Inventory of Medicinal Supplies Report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <section class="panel">
                     <header class="panel-heading" style="color: white; background-color: gray">
                        Inventory of Medicinal Supply Items Stocks Report
                    </header>
                <!--CHART-->
                                ...
                                <div style="margin-top: 10px; margin-left: 15px">
                                    <div style="text-align: left; ">
                                        ...
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            This report shows the details of the university campus' current inventory stocks of medicinal items. Details may be filtered by the one who generated this report in order to specify the significant details of the said report.
                                        </p>
                                    ...
                                    <h5>Table Description:</h5> 
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The table below shows the filtered details of the current medicinal items stocks status as of <?php echo date('F d, Y')?>.
                                        </p>
