                ...
                <li>
                   ...
                   <ul class="active" >
                        ...
                        <li><a class="active" href="javascript:;">Inventory Stocks</a>
                           <ul class="active" >
                              <li><a class="active" href="DMReportInvOff.php">Office Supplies</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMReportInvOff.php">Inventory of Office Supplies Report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                         ...
                         <div style="display: none" id="printablearea">
                                ...
                                <div style="margin-top: 10px; margin-left: 15px">
                                    ...
                                    <h5>Table Description:</h5> 
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The table below shows the filtered details of the office supply items stocks status as of <?php echo date('F d, Y')?>.
                                        </p>
