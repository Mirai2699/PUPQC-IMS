            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                   ...
                   <ul class="active" >
                        ...
                        <li><a class="active"  href="DMReportIss.php">Issuance</a></li> 
    ...
    <section id="main-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMReportIss.php">Issuance of Items Report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <section id="content">
         <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading" style="color: white; background: gray">
                        Issuance of Items per Departments Report
                    </header>
                <!--CHART-->
                ...
                <div>
                   ...
                   <div id="ReqRanking" style="width: 97%; height: 350px; margin: 0 auto"></div>
                  ...
                  <div class="panel-body">
                    <div class="adv-table">
                        <div class="col-md-12" style="text-align: left">
                             ...
                             <div class="col-md-2"  style="text-align: right; padding-top: 22px">
                                <div class="form-group">
                         ...
                         <div style="display: none" id="printablearea">
                                ...
                                <div style="margin-top: 10px; margin-left: 15px">
                                    <div style="text-align: left; ">
                                        <h5 style="font-size: 15px; text-align: right">Report No. IR-<?php echo date('m-d'); ?> </h5>
                                        <h5 style="font-size: 15px">Date Generated: <br>
                                            <?php echo date('F d, Y'); ?>
                                        </h5>
                                        <center>
                                            <b style="font-size: 20px">Issuance of Supplies Report</b>
                                        </center>
                                        ...
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The chart shows the graphical details of the departmental ranking frequency of request and their supplies procurement.
                                        </p>
                                    </div>
                                    <div>
                                            <script src="js/code/highcharts.js"></script>
                                           ...
                                           <div id="ReqRanking1" style="width: 97%; height: 350px; margin: 0 auto"></div>
                                    ...
                                    <h5>Table Description:</h5> 
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The table below shows the filtered details of the issuance of items within the university campus as of <?php echo date('F d, Y')?>.
                                        </p>
