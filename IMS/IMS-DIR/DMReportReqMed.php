                   ...
                   <ul class="active" >
                        <li><a class="active" href="javascript:;">Requisition</a>
                           <ul class="active" >
                              ...
                              <li><a class="active" href="DMReportReqMed.php">Medicinal Supplies</a></li> 
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMReportReqMed.php">Requisition of Medicinal Supllies Report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading" style="background-color: gray; color:white">
                        Requisition Report for Medicinal Supplies
                    </header>
                                ...
                                <div class="col-md-10" style="text-align: left">
                                     ...
                                     <div class="col-md-6" style="border-style: solid; border-width: 1px">
                                        ...
                                        <div class="col-md-1" style="margin-top: 21px">
                                            <button type="submit" class="btn btn-info" name="FilterMEDRequisition">Filter</button><br> 
                                        </div>
                         ...
                         <div style="display: none" id="printablearea">
                                ...
                                <div style="margin-top: 10px; margin-left: 15px">
                                    <div style="text-align: left; ">
                                        <h5 style="font-size: 15px; text-align: right">Report No. MRR-<?php echo date('m-d'); ?> </h5>
                                        <h5 style="font-size: 15px">Date Generated: <br>
                                            <?php echo date('F d, Y'); ?>
                                        </h5>
                                        <center>
                                            <b style="font-size: 20px">Medicinal Supplies Requisition Report</b><br>
                                        </center>
                                        <h5>Report Description:</h5> 
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            This report is shoes the details of the university campus' medicinal supplies detailed information of the requisition records. Details may be filtered by the one who generated this report in order to specify the significant details of the said report.
                                        </p>
                                    ...
                                    <h5>Table Description:</h5> 
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The table below shows the filtered details of medicinal supply items requisition records as of <?php echo date('F d, Y') ?>.
                                        </p>
