        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMReviewApr.php?viewrequests=<?php echo $ids; ?>">Request Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="text-align: center;">
                                                            <div class="modal-header">
                                                                You are about to release a request form. Are you sure you want to proceed?
                                                            </div>
                                                                ...
                                                                <?php
                                                                          $sql = "SELECT * FROM `ims_t_summary_request` WHERE Batch_No = $ids";
                                                                                ...
                                                                                while($row = mysqli_fetch_assoc($result))
                                                                                {
                                                                                  $bn = $row['Batch_No'];
                                                                    ?>
                                                                 <a href="ChangeStat.php?viewrequestsoff=<?php echo $bn; ?>" class="btn btn-success btn-lg"> Yes </a> &nbsp&nbsp&nbsp&nbsp
                                                                 <?php } ?>
                                        ...
                                        <?php
                                              $sql = "SELECT * FROM `ims_t_summary_request` WHERE Batch_No = $ids";
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result))
                                                    {
                                                      $bn = $row['Batch_No'];
                                        ?>
                                         <a href="ChangeStat.php?viewrequestsoff=<?php echo $bn; ?>" class="btn btn-info" style=" background-color: green ; padding-left: "><i class="fa fa-check"></i> Release </a>&nbsp&nbsp 
                                                    <?php } ?>
                                        <a href="DMAprReq.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Approved Requests</a>          
                                    </div>
                                </div>
