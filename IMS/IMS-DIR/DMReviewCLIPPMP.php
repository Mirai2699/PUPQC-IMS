        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMReviewCLIPPMP.php?viewrequests=<?php echo $ids; ?>">Plan Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <?php  
                            ...
                            //$ids = $row['Batch_No'];
                            $sql = "SELECT * FROM `ims_t_ppmp_clinic_summary` WHERE MED_PPMP_ID = $ids";
                       ...
                       <header class="panel-heading" style="background-color: gray; color: white">
                         Project procurement management plan for Medical Clinic Supplies and Materials details for PPMP ID: <?php echo $ids; ?>
                        </header>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="adv-table">
                                        <table  class="display table table-bordered table-striped" id=" ">
                                            ...
                                            <tbody> 
                                                <?php  
                                                        $sql = "SELECT * FROM `ims_t_ppmp_clinic_summary` AS SUMREQ  
                                                                INNER JOIN `ims_t_ppmp_clinic_details` AS REQ ON REQ.Batch_No = SUMREQ.MED_PPMP_ID
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:22px;">
                                         ...
                                         <a href="DMPPMP.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back</a>
                                    </div>
                                </div>
                                 <!-- TABLE START -->
                                            <div style="display: none" id="printablearea2">
                                                    ...
                                                    <div  style="font-family: arial; font-size: 14px; color: black;text-align: center;">
                                                           ...
                                                           Medical Clinic Supplies and Materials<br>
                                                    </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center">
                                                                    <br><br><br><br>
                                                                    <?php
                                                                                         $sqlemp= "SELECT * FROM `ims_t_ppmp_clinic_summary` ";
                                                                                                    $results = mysqli_query($connection, $sqlemp) or die("Bad Query: $sql");
                                                                                                    while($row = mysqli_fetch_assoc($results))
                                                                                                            {
                                                                                                                $fname = $row['MED_PPMP_Requested_By'];
                                                                                                                $job = $row["MED_PPMP_Job_Type"];
                                                                                                                
                                                                                                                if($job == "Branch Physician")
                                                                                                                {
                                                                                                                    echo"
                                                                                                                    <p><b style='text-decoration: underline;'> $fname, MD</b><br>
                                                                                                                        $job
                                                                                                                    </p> ";
                                                                                                                }
                                                                                                                else if($job == "Branch Dentist")
                                                                                                                {
                                                                                                                    echo"
                                                                                                                    <p><b style='text-decoration: underline;'> $fname </b><br>
                                                                                                                        $job
                                                                                                                    </p> ";
                                                                                                                }
                                                                      ?>
