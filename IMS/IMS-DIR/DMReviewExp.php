            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    ...
                    <ul class="active">
                        ...
                        <li><a class="active" href="DMExpReq.php">Expired and Rejected</a></li>                  
                    </ul>
                </li>
                <li>
                    <a href="DMPPMP.php">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMExpReq.php">Expired / Rejected Requests</a></li>
                    <li><a href="DMReviewExp.php?viewrequests=<?php echo $ids; ?>">Request Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                   ...
                                   <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="Date" name="Datedelv" value="<?php echo $daterej; ?>" class="form-control" readonly="" disabled style="color: black;" />
                                        </div>
                                    </div>
                        ...
                        ?>
                                                ...
                                                <?php  
                                                    $sql = "SELECT * FROM `ims_t_summary_request` AS SUMREQ  
                                                            INNER JOIN `ims_t_requisition` AS REQ ON REQ.Batch_No = SUMREQ.Batch_No
                                                                 WHERE SUMREQ.Status_Req = 'RELEASE' AND Accept_Status = 'EXPIRED' OR Accept_Status = 'REJECTED' AND REQ.Batch_No = $ids  
                            ...
                            <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:22px; text-align: right">
                                        <a href="DMExpReq.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back</a>          
                                    </div>
                            </div>
