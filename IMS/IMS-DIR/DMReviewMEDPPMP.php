        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DMReviewMEDPPMP.php?viewrequests=<?php echo $ids; ?>">Plan Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center">
                                                                    <br><br><br><br>
                                                                    <?php
                                                                                         $sqlemp= "SELECT * FROM `ims_t_ppmp_med_summary` ";
                                                                                                    $results = mysqli_query($connection, $sqlemp) or die("Bad Query: $sql");
                                                                                                    while($row = mysqli_fetch_assoc($results))
                                                                                                            {
                                                                                                                ...
                                                                                                                {
                                                                                                                    echo"
                                                                                                                    <b><b style='text-decoration: underline;'> $fname, MD</b><br>
                                                                                                                        $job
                                                                                                                    </b> ";
                                                                                                                }
