        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DM_CLIReviewPen.php?viewrequests=<?php echo $ids; ?>">Request Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        ?>
                            ...
                            <form role="form" method="POST" action="F_CLIChangeStat.php">
                            <div class="row group">      
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="r_status" style="color: black;"required>
                                            <option value="APPROVED">Approve Request</option>
                                            <option value="REVISE">Revise Request</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="text-align: center;">
                                                            ...
                                                            <div class="panel" style="height: 50%; width: 100%">
                                                                <button type="submit" class="btn btn-success btn-lg" name="CLI_Cont">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
                                        ...
                                        <a href="DMPenReq.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back</a>                      
                                    </div>
                                </div>
                            </div>
                            </form>
