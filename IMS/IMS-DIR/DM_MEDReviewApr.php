        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="DM_MEDReviewApr.php?viewrequests=<?php echo $ids; ?>">Request Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                        ...
                                        <?php
                                              $sql = "SELECT * FROM `ims_t_med_summary_request` WHERE Batch_No = $ids";
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result))
                                                    {
                                                      $bn = $row['Batch_No'];
                                        ?>
                                         <a href="ChangeStat.php?viewrequests=<?php echo $bn; ?>" class="btn btn-info" style=" background-color: green ; padding-left: "><i class="fa fa-check"></i> Release </a>&nbsp&nbsp 
                                                    <?php } ?>
