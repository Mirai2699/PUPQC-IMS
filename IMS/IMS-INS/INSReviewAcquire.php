                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input style="color: black;" type="number" name="a_quan" value="<?php echo $quantity; ?>" min="1" max="1000" class="form-control"required/>
                                                                                            </div>
                                                                                         </div>
                            ...
                            <!--<a data-toggle="modal" class="btn btn-success" href="DMPrintRequest.php?viewrequests=<?php echo $ids; ?>">View</a>-->
                                ...
                                <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:22px; text-align: right">
                                        ...
                                        &nbsp&nbsp
                                        <a href="INSacquire.php#home" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Delivered Items</a>          
                                    </div>
                                </div>
