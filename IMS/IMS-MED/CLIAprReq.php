                    ...
                    <tbody>
                        <?php 
                           $accid = $_SESSION['AccountID'];
                            $view_query = mysqli_query($connection,"SELECT * FROM `ims_t_clinic_summary_request` AS SUMREQ
                                                                    INNER JOIN pso_r_user AS ACC
                                                                    ON SUMREQ.Account_ID = ACC.U_ID
                                                                    WHERE SUMREQ.Status_Req = 'APPROVED' OR SUMREQ.Status_Req = 'RELEASED'  
                                                                    AND ACC.U_ID = '$accid' ORDER BY Batch_No DESC");
                                            ...
                                            if($stat == "APPROVED")
                                             {
                                                echo       
                                                    "<td style='text-align:center'>
                                                         ...
                                                         <a href='CLIReviewApr.php?viewrequests=$bn' class='btn btn-success'>Review</a> 
                                                    </td>";
                                             }
                                             else if($stat == "RELEASED")
                                             {
                                                echo       
                                                    "<td style='text-align:center'>
                                                         ...
                                                         <a href='CLIReviewRel.php?viewrequests=$bn' class='btn btn-info'>Review</a> 
                                                    </td>";
                                             }
                                             else if($stat == NULL)
                                             {
