        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="CLIDelivery.php">For Delivery / Delivered Requests</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                            ...
                            <div class="col-sm-12">
                                <section class="panel">
                                  ...
                                  <div class="panel-body">
                                    ...
                                    <tbody>
                                        <?php
                                            $view_query = mysqli_query($connection,"SELECT * FROM `ims_t_clinic_summary_request` WHERE Status_Req = 'RELEASED'                     AND Acquired_Status = 'PENDING' ORDER BY Batch_No DESC ");
                                        ...
                                        ?>      
                                                 <tr class="gradeX">
                                                        ...
                                                        <td>
                                                                <center>
                                                                <a href="CLIReviewDel.php?viewrequests=<?php echo $bn; ?>" class="btn btn-warning">Check Status</a>               
                                                                </center>
                                                       </td>
                                                </tr>  
                            ...
                            <div class="col-sm-12">
                                <section class="panel">
                                  ...
                                  <div class="panel-body">
                                    ...
                                    <tbody>
                                        <?php
                                            $view_query = mysqli_query($connection,"SELECT * FROM `ims_t_clinic_summary_request` WHERE Status_Req = 'RELEASED'                  AND Acquired_Status = 'ACQUIRED' ORDER BY Batch_No DESC");
                                            while($row = mysqli_fetch_assoc($view_query))
                                                {
                                                    $bn = $row["Batch_No"];
                                                    $DR = $row["Date_Requested"];
                                        ...
                                        ?>      
                                                 <tr class="gradeX">
                                                        ...
                                                        <td style='width:150px'>
                                                                <center>
                                                                <a href="CLIReviewDel.php?viewrequests=<?php echo $bn; ?>" class="btn btn-info">View</a>               
                                                                </center>
                                                       </td>
                                                </tr>  
