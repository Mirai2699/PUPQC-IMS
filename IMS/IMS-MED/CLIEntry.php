         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="CLIEntry.php">Add New Item</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                                                                    ...
                                                                                    <div class="col-md-12" style="margin-bottom: 5px">
                                                                                           ...
                                                                                           <div class="col-md-12" style="background-color: #69f0ae; border-style: solid;">
                                                                                            ...
                                                                                            <div class="col-md-2">
                                                                                                <div class="form-group">
                                                                                                    <label for="exampleInputEmail1">Quantity</label>
                                                                                                    <input style="color: black;" type="number" id="newquan"  name="a_new_quan"  class="form-control" disabled="disabled" maxlength="4" min="1" max="1000"required/>
                                                                                                </div>
                                                                                            </div>
