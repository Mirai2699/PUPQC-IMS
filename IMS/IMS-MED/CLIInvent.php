         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="CLIInvent.php">Inventory Setup</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
             ...
             <section class="panel">
                    <header class="panel-heading" style="color: white; background-color: gray">
                        Single Item Entry and Critical Level Modification Form for Clinical Supplies
                    </header>
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                          ...
                          <div class="panel-body">
                            ...
                            <tbody>
                                <?php
                                    $view_query = mysqli_query($connection,"SELECT * FROM `ims_r_clinical_stock` WHERE Quantity >= 1");
                                                                    ...
                                                                    <div class="row group">                                                        
                                                                        ...
                                                                        <div class="col-md-8">
                                                                         ...
                                                                         <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Item Category</label>
                                                                                <input maxlength="150" type="text" name="item_cat" class="form-control" required="" readonly="" style="color: black;"  
