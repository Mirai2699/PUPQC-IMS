                            ...
                            <ul class="active">
                                ...
                                <li><a class="active" href="javascript:;"><i class="fa  fa-tasks"></i>Inventory Status</a>
                                    <ul class="active">
                                        ...
                                        <li><a class="active" href="CLIInventstat.php">Clinical Stocks</a></li>
                                    </ul>
                                </li>  
                            </ul>
                        </li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="CLIInventstat.php">Inventory Stocks Report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                ...
                                <div style="margin-top: 10px; margin-left: 15px">
                                    <div style="text-align: left; ">
                                        ...
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            This report is shoes the details of the university campus' current inventory stocks of medical and clinic items. Details may be filtered by the one who generated this report in order to specify the significant details of the said report.
                                        </p>
                                    ...
                                    <h5>Table Description:</h5> 
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The table below shows the filtered details of the current medical and clinic items stocks status.
                                        </p>
