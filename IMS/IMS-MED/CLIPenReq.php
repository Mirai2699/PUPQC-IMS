                        ...
                        <?php 
                          $accid = $_SESSION['AccountID'];
                            $view_query = mysqli_query($connection,"SELECT * FROM `ims_t_clinic_summary_request` AS SUMREQ
                                                                    ...
                                                                    WHERE SUMREQ.Status_Req = 'PENDING' AND ACC.U_ID = '$accid' ORDER BY Batch_No DESC");
                        ...
                        ?>      
                                 <tr class="gradeX">
                                        ...
                                        <td style='width:150px'>
                                                ...
                                                <a data-toggle="modal" class="btn btn-success" href="CLIReviewPen.php?viewrequests=<?php echo $bn; ?>">Review</a>               
                                                </center>
                                       </td>
                                </tr>  
                                    <?php 
