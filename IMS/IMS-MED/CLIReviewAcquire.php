                 ...
                 <li>
                    ...
                    <ul class="active">
                        ...
                        <li><a class="active" href="javascript:;"><i class="fa  fa-download"></i>Acquisition</a>
                            <ul class="active" >
                                <li><a class="active" href="CLIDelivery.php">Delivery</a></li>
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                    ...
                                                                                                    <select name="a_old_sku" class="form-control" id="myText" style="color: black; margin-bottom: 87px;">
                                                                                                         <option value="" selected disabled></option>
                                                                                                                        ...
                                                                                                                        <?php  
                                                                                                                            $sqlemp= "SELECT DISTINCT Stock_Key_Unit, Item_Name FROM `ims_r_clinical_stock` AS MEDSTK INNER JOIN ims_t_clinic_requisition AS MEDREQ ON MEDSTK.Item_Category = MEDREQ.CLI_Category

                                                                                                                            where MEDSTK.Item_Category  = MEDREQ.CLI_Category";
                                                                                                  ...
                                                                                                  <button  name="CLIDevAcquireOLD" id="btnold" class="btn btn-warning" style="margin-bottom: 10px; margin-top: 10px"><i class="fa  fa-download"></i>  
                                                                                       ...
                                                                                       <div class="col-md-6" style="background-color: #69f0ae;border-style: solid;" >
                                                                                           ...
                                                                                           <div class="form-group">
                                                                                             ...
                                                                                             <div class="form-group">
                                                                                              ...
                                                                                              <button  name="CLIDevAcquireNEW" id="btnnew" disabled="disabled" class="btn btn-success" style="margin-bottom: 10px; margin-top: 10px"><i class="fa  fa-download"></i>  
                                                                                              Confirm Entry </button>&nbsp&nbsp
                                                                                       </div>
                            ...
                            <!--<a data-toggle="modal" class="btn btn-success" href="DMPrintRequest.php?viewrequests=<?php echo $ids; ?>">View</a>-->
                                ...
                                <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:22px; text-align: right">
                                        ...
                                        &nbsp&nbsp
                                        <a href="CLIEntry.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Delivered Items</a>          
                                    </div>
                                </div>
