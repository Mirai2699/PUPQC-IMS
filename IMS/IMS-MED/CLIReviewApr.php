        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="CLIReviewApr.php?viewrequests=<?php echo $ids; ?>">Approved Request Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                            ...
                            <div class="row group">              
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-12" style="padding-top:15px; text-align: right">
                                        <a href="CLIAprReq.php" class="btn btn-default" style=" background-color: gray; margin-bottom: 10px ">Go Back to Approved Requests </a>     
                                        <br>     
                                    </div>
