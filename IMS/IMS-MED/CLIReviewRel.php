...
<title>Review Released Requests | PUPQCIMS</title>
                    ...
                    <ul class="active" >
                        <li><a class="active" href="javascript:;"><i class="fa  fa-envelope"></i>Requisition</a>
                            <ul class="active" >
                                ...
                                <li><a class="active" href="CLIAprReq.php">Approved Requests</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:;"><i class="fa  fa-download"></i>Acquisition</a>
                            <ul class="sub">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="CLIAprReq.php">Released / Printed Requests</a></li>
                    <li><a href="CLIReviewRel.php?viewrequests=<?php echo $ids; ?>">Request Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                        ...
                                        <table  class="display table table-bordered table-striped" id=" ">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Item Name</th>
                                                    <th style="width:250px">Item Category</th> 
                                                                        ...
                                                                        <tr class="gradeX">
                                                                         ...
                                                                         <tr class="gradeX">
                                                                            ...
                                                                            <td style="text-align: center; border-color: white">
                                                                                 <?php
                                                                                 $AC_ID = $_SESSION['AccountID'];
                                                                                 $sqlemp= "SELECT * FROM `pso_r_employee_profile` AS EMP 
                                                                                            INNER JOIN  `pso_r_user` AS ACC WHERE ACC.U_ID = '$AC_ID' and
                                                                                            EMP.EP_ID = ACC.EP_ID";
                                                                                            $results = mysqli_query($connection, $sqlemp) or die("Bad Query: $sql");
                                                                                            while($row = mysqli_fetch_assoc($results))
                                                                                                    {
                            ...
                            <!--<a data-toggle="modal" class="btn btn-success" href="DMPrintRequest.php?viewrequests=<?php echo $ids; ?>">View</a>-->
                                ...
                                <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:22px; text-align: right">
                                        ...
                                        <button onclick="printDiv2('printablearea2')" class='btn btn-default' style='background-color: green; color: white'><i class='fa fa-print'></i>    Print a Copy of RIS</button>


                                        &nbsp&nbsp
                                        <a href="CLIAprReq.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Released Requests</a>          
                                    </div>
                                </div>
