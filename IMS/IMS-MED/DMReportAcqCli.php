        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="CLIProcRep.php">Procurement Report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                         ...
                         <div style="display: none" id="printablearea">
                                ...
                                <div style="margin-top: 10px; margin-left: 15px">
                                    <div style="text-align: left; ">
                                        ...
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The chart shows the graphical details of the medical and clinic items frequency of procurement per mode of acquisition.
                                        </p>
                                    </div>
                                    <div>
                                            <script src="js/code/highcharts.js"></script>
                                    ...
                                    <h5>Table Description:</h5> 
                                        <p style="text-align: justify; font-size: 14px">   &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp
                                                            The table below shows the filtered details of the current medical and clinic items procurement records as of <?php echo date('m-d-Y') ?>.
                                        </p>
