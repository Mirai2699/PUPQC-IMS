<?php
     ...
     $db = mysqli_connect('localhost','root','','pupqc_ams_ims_db');
        ...
        $acqins = "INSERT INTO ims_t_ppmp_clinic_summary
...
<?php  
    ...
    $stmt = $dbh->prepare("INSERT INTO ims_t_ppmp_clinic_details
                                        (Item_Name, 
                                         Unit, 
                                    --   Quantity, 
                                         Est_Budget, 
        ...
        $stmt->execute();
                ...
                echo "<script type=\"text/javascript\">".
                         ...
                         ('You have successfully created a PMPP!  You will be redirected to a page to view your recently created plan');".
                          "</script>";
                echo "<script>setTimeout(\"location.href = 'MEDReviewCLIPPMP.php?viewrequests=$ursid'\",0);</script>"; 
