        ...
        $db = mysqli_connect('localhost','root','','pupqc_ams_ims_db');
            ...
            if(isset($_POST['MEDEvaluateNEW'])) //FOR ACQUIRING NEW ITEMS FROM DIFFERENT MODES
            {
               ...
               // $rem = $_POST['a_remarks']; 
                ...
                $acqins = "INSERT INTO ims_t_acquisition_med(Date_Procured, Mode_Acquisition, Item_SKU, Quantity, Supplier)     
            ...
            else if(isset($_POST['MEDEvaluateOLD'])) //FOR ACQUIRING EXISTING ITEMS FROM DIFFERENT MODES
            {
               ...
               // $rem = $_POST['a_remarks']; 
                ...
                //$update = mysqli_query($db,"UPDATE ims_r_medicinal_stock SET Quantity = (Quantity + $quan) WHERE Med_Code = '$sku' "); 
