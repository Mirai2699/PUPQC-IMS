                ...
                <li>
                    ...
                    <ul class="active" >
                        <li><a class="active" href="javascript:;"><i class="fa  fa-envelope"></i>Requisition</a>
                            <ul class="active" ">
                                <li><a class="active" href="MEDAddNewReq.php">Add New Items</a></li>
         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="MEDAddNewReq.php">Add New Request</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>      
        ...
        <div class="col-md-12">
         <!-- START CONTENT -->
            ...
            <section class="panel">
                    ...
                    Medicinal Supplies that are recommended for Requisition and Procurement
                    </header>
                                    <div>
                                    ...
                                    <div id="inventory" style="width: 97%; height: 300px;"></div>
                                            ...
                                            <table style="display: none;" id="datatableinv">
                                                ...
                                                <tbody>
                                                    <?php
                                                        //$off = $_SESSION['DEPART'];
                                                        $view_query = mysqli_query($connection,"SELECT DISTINCT MED_Name, Quantity, Med_Expired FROM                                  `ims_r_medicinal_stock`
                                                                                               WHERE Quantity <= Critical_level and Med_Expired > CURRENT_TIMESTAMP");
                                                        while($row = mysqli_fetch_assoc($view_query))
                                                            {   
                                                                $name = $row["MED_Name"];
                                                                $quan = $row["Quantity"];
                                                                $expdate = new DateTime($row["Med_Expired"]);
                                                                $date = $expdate->format('F d,Y');
                                                    ?>      
                                                    <tr>
                                                        <th><?php echo $name.'<br>Exp Date: '.$date?></th>
                                                        <td><?php echo $quan; ?></td>
                                                    </tr>
                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            <table class="display table table-bordered table-striped">                                
                                <tr>
                                    <td>                            
                                        <form action="F_Med_AddRequest.php" method="POST">
                                            ...
                                            <div class="form-content">
                                                ...
                                                <?php  
                                                    ...
                                                    $result = mysqli_query($connection, "SELECT MAX(Sum_No) FROM ims_t_med_summary_request");
                                                 ...
                                                 <div class="form-group">
                                                    <input type="hidden" name="r_batch" value="<?php echo $finalid; ?>">
                                                       ...
                                                       <?php
                                                                ...
                                                                <div class="col-md-3" style="display:none;">
                                                                    <input type="text" class="form-control" name="r_uid" value="<?php echo $acc; ?>">
                                                                </div>
                                                                <?php }
                                                                     ?>
