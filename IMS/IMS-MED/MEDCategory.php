...
<title>Manage Medicine Supplies Category | PUPQC PSO</title>
                    ...
                    <ul class="active" >
                        ...
                        <li><a href="javascript:;"><i class="fa  fa-download"></i>Acquisition</a>
                         ...
                         <li><a class="active" href="javascript:;"><i class="fa fa-tasks"></i>Inventory Management</a>
                            <ul class="active">
                                <li><a class="active" href="MEDCategory.php">Setup Item Category</a></li>
         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="MEDCategory.php">Manage Item Category</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content" style="text-align: center;">
                                                                        ...
                                                                        <div class="panel" style="height: 50%; width: 100%">
                                                                            <button type="submit" class="btn btn-success btn-lg" name="addmedcat">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                          ...
                          <div class="panel-body">
                            ...
                            <tbody>
                                <?php
                                    $view_query = mysqli_query($connection,"SELECT * FROM `ims_r_medicine_category` WHERE DEF_Active = 1 ");
                                                         ...
                                                         <div class="modal-body">
                                                              <form action="F_Category.php" method="POST">
                                                                    <div class="form-content">
                                                                     ...
                                                                     <div class="panel" style="height: 50%; width: 100%">
                                                                        <button type="submit" class="btn btn-success " name="editmedcat"><i class="fa  fa-save"></i>   Save</button> &nbsp&nbsp&nbsp&nbsp
                                                                    </div>
