                        ...
                        <li><a href="javascript:;"><i class="fa  fa-download"></i>Acquisition</a>
                         ...
                         <li><a class="active" href="javascript:;"><i class="fa fa-tasks"></i>Inventory Management</a>
                            <ul class="active">
                                ...
                                <li><a class="active" href="MEDInvent.php">Manage Critical Level <br>and Items' Status</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="MEDInvent.php">Inventory Setup</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                                ...
                                                <div class="row group">   
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input style="color: black; padding-right: 2px;" type="number" name="a_quan" class="form-control" required="" min="1" max="1000" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                          <div class="form-group">
                          ...
                          <div class="panel-body">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 7%">Expiration Date</th>
                                    <th style="width: 7%; text-align: center">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                    $view_query = mysqli_query($connection,"SELECT * FROM `ims_r_medicinal_stock` WHERE Quantity >= 1 and Med_Status = 'Stocked'");
                                ...
                                ?>      
                                         <tr class="gradeX">
                                                ...
                                                <td style="width: 10%"><?php echo $unit; ?></td>
                                                    ...
                                                    ?>
                                                     <?php 
                                                        if($exp <= $datenow)
                                                        {  ?>
                                                            <td style="width: 5%; background-color: darkviolet; color: white"><?php echo  $exp; ?></td>
                                                    ...
                                                    ?>
                                                     <?php 
                                                        if($exp > $datenow)
                                                        {  ?>
                                                            <td style="width: 5%"><?php echo  $exp; ?></td>
                                                ...
                                                <td style="width: 7%">
                                                        ...
                                                        <a data-toggle="modal" href="#Change<?php echo $No; ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i></a>     
                                                         <a data-toggle="modal" href="#delete<?php echo $No; ?>" class="btn btn-danger"><i class="fa fa-times"></i></a>               
                                                        </center>
                                               </td>
                                        </tr>   
                                        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="Change<?php echo $No; ?>" class="modal fade">
                                                                    ...
                                                                    <div class="row group">                                                        
                                                                        ...
                                                                        <div class="col-md-8">
                                                                         ...
                                                                         <div class="col-md-3">
                                                                            <div class="form-group">
                                                                                <label>Quantity</label>
                                                                                <input maxlength="150" type="text" name="item_quan" class="form-control" required="" style="color: black;"  min="1" max="1000"
                                                                                value="<?php echo $quan; ?>" />
                                                                            </div>
                                                                        </div>
                                             ...
                                             <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="delete<?php echo $No; ?>" class="modal fade">
                                                       <div class="modal-dialog">
                                                         <div class="modal-content" style="text-align: center;">
                                                              <div class="modal-header">
                                                                You are about to dispose this item. Are you sure you want to proceed?
                                                              </div>
                                                              <img alt="" src="../../Resources/images/PUP/reject.png" style="height: 20%; width: 20%">
                                                               <form action="F_Supplies.php" method="POST">
                                                                    <div class="form-content">
                                                                        <div class="row group">                                                        
                                                                            <input type="hidden" name="item_No" class="form-control" required="" style="color: black;"  
                                                                     ...
                                                                     <div class="panel" style="height: 50%; width: 100%">
                                                                         <button type="submit" class="btn btn-success btn-lg" name="MEDICDispose">   Yes  
