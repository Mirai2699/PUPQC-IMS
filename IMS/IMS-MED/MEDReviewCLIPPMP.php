                        ...
                        <ul class="active" >
                             ...
                             <li><a class="active" href="CLIPPMP.php">Clinical Stocks</a>
                                 <ul class="active" >
                                   ...
                                   <li><a class="active" href="CLI_VIEWPPMP.php">View Plans</a></li>
                                    </ul>
                             </li>
                        </ul>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="CLI_VIEWPPMP.php">View PPMP</a></li>
                    <li><a href="MEDReviewCLIPPMP.php?viewrequests=<?php echo $ids; ?>">Plan Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:22px;">
                                        ...
                                        <a href="CLI_VIEWPPMP.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Pending Requests</a>          
                                    </div>
                                </div>
                                 <!-- TABLE START -->
