        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="MEDReviewDel.php?viewrequests=<?php echo $ids; ?>">Review Details</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                            ...
                            <!--<a data-toggle="modal" class="btn btn-success" href="DMPrintRequest.php?viewrequests=<?php echo $ids; ?>">View</a>-->
                                ...
                                <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:22px; text-align: right">
                                                            ...
                                                            <input type="Date" name="DeliveredDate" class="form-control" value="<?php echo date('Y-m-d')?>" style="color: black; display:none"  />
                                                              <div class="panel" style="height: 80%; width: 80%">
                                                                ...
                                                                <div class="panel" style="height: 50%; width: 100%">
                                                                    <button class="btn btn-success btn-lg" type="submit" name="MEDDelivered">Yes</button> &nbsp&nbsp&nbsp&nbsp
                                        ...
                                        &nbsp&nbsp
                                        <a href="MEDDelivery.php#delivered" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Released Requests</a>          
                                    </div>
                                </div>
