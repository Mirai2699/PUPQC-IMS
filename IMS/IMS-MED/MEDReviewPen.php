                    ...
                    <ul class="active" >
                        <li><a class="active" href="javascript:;"><i class="fa  fa-envelope"></i>Requisition</a>
                            <ul class="active" ">
                                ...
                                <li><a class="active" href="MEDPenReq.php">Pending Requests</a></li>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form role="form" method="POST" action="ChangeStat.php">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input style="color: black;" type="number" name="r_quan" value="<?php echo $quantity; ?>" class="form-control" min="1" max="50"/>
                                                                    </div>

                                                                    <br><hr>
                                                                   
                                                                    <button type="submit" class="btn btn-success" name="MEDPENsave">Save</button>
                            ...
                            <div class="row group">              
                                ...
                                <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:0px;">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="text-align: center;">
                                                            ...
                                                            <div class="panel" style="height: 50%; width: 100%">
                                                                <button type="submit" class="btn btn-success btn-lg" name="MEDBatchSave">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
                                        ...
                                        <a href="MEDPenReq.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Pending Requests</a>          
                                    </div>
