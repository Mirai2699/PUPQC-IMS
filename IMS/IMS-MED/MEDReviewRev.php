                    ...
                    <ul class="active" >
                        <li><a class="active" href="javascript:;"><i class="fa  fa-envelope"></i>Requisition</a>
                            <ul class="active" ">
                                ...
                                <li><a class="active" href="MEDRevReq.php">Requests for Revision</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="MEDReviewRev.php?viewrequests=<?php echo $ids; ?>">Request for Revision Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form role="form" method="POST" action="ChangeStat.php">
                                                                    ...
                                                                    <button type="submit" class="btn btn-success" name="MEDsave">Save</button>
                                                                    &nbsp&nbsp
                            ...
                            <div class="row group">              
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" style="padding-top:22px;">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="text-align: center;">
                                                            ...
                                                            <div class="panel" style="height: 50%; width: 100%">
                                                                <button type="submit" class="btn btn-success btn-lg" name="MEDResend">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
                                        ...
                                        <a href="MEDRevReq.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Requests for Revision</a>          
                                    </div>
