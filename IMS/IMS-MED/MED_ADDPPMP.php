                    ...
                    <a class="active" href="javascript:;"><i class="fa  fa-calendar"></i>PPMP</a>
                        <ul class="active" >
                              <li><a class="active" href="MEDPPMP.php">Medicinal Stocks</a>
                                  <ul class="active" >
                                     <li><a class="active" href="MED_ADDPPMP.php">Create Plan</a></li>
         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="MED_ADDPPMP.php">Add PPMP</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>      
         ...
         <!-- START CONTENT -->
            ...
            <section class="panel">
                    <header class="panel-heading"  style="background-color: gray; color: white">
                       Create a Project procurement management plan for medicinal supplies<br>
                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            <table class="display table table-bordered table-striped">                                
                                <tr>
                                    <td>                            
                                        <form action="F_ADDMED_PPMP.php" method="POST">
                                            ...
                                            <div class="form-content">
                                                ...
                                                <div class="row">
                                                   ...
                                                   <?php  
                                                    ...
                                                    $result = mysqli_query($connection, "SELECT MAX(MED_PPMP_ID) FROM ims_t_ppmp_med_summary");
                                                     ...
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="r_name[]"  class="form-control" style="color: black;" required="" >
                                                                <option selected disabled value=""></option>
                                                                   <?php  
                                                                      $sqlemp= "SELECT DISTINCT Med_Name, Med_Category
                                                                       FROM `ims_r_medicinal_stock` ORDER BY Med_Category ASC";
                                                                      $results = mysqli_query($connection, $sqlemp) or die("Bad Query: $sql");
                                                                            while($row = mysqli_fetch_assoc($results))
                                                                             {  
                                                                              $name = $row['Med_Name'];
                                                          ...
                                                          <div class="form-group">
                                                             <label>Unit</label>
                                                              <select name="r_unit[]" class="form-control" style="color: black;" >
                                                                ...
                                                                <option value="Sachetes">Sachet</option>
