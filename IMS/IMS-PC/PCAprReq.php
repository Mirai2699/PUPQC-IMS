         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PCAprReq.php">Approved Request</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
            ...
            <div class="col-sm-12">
                ...
                <form class="col s12">
                  ...
                  <div class="panel-body">
                    ...
                    <tbody>
                        <?php
                            $view_query = mysqli_query($connection,"SELECT * FROM `ims_t_summary_request` WHERE Status_Req = 'APPROVED'");
                        ...
                        ?>      
                                 <tr class="gradeX">
                                        ...
                                        <td style='width:150px'>
                                                ...
                                                <a href="PCReviewApr.php?viewrequests=<?php echo $bn; ?>" class="btn btn-success">View</a>               
                                                </center>
                                       </td>
                                </tr>  
