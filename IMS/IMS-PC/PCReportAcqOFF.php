            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    ...
                    <ul class="active" >
                        ...
                        <li><a class="active" href="PCReportAcqOff.php">Procurement</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PCReportAcqOff.php">Acquisition Report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                        ...
                        tooltip: {
                            formatter: function () {
                                return '<b>' + this.series.name + '</b><br/>' +
                                    this.point.y + ' ' + 'items from'+ ' ' + this.point.name.toLowerCase();
                            }
                        }
                    });
                    </script>
