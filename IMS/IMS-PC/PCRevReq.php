         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PCRevReq.php">Requests for Revision</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                              ...
                              <div class="panel-body">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Date Revised</th>
                                        <th>Remarks for Revision</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        $view_query = mysqli_query($connection,"SELECT * FROM `ims_t_summary_request` WHERE Status_Req = 'REVISE'");
                                    ...
                                    ?>      
                                             <tr class="gradeX">
                                                    ...
                                                    <td style='width:150px'>
                                                            ...
                                                            <a href="PCReviewRev.php?viewrequests=<?php echo $bn; ?>" class="btn btn-warning">Edit</a>               
                                                            </center>
                                                   </td>
                                            </tr>  
