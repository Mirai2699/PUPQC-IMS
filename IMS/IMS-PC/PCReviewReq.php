        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PCReviewReq.php?viewrequests=<?php echo $ids; ?>">Request Review</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form role="form" method="POST" action="ChangeStat.php">
                                                                    ...
                                                                    <button type="submit" class="btn btn-success" name="PCPENsave">Save</button>
                                                                    &nbsp&nbsp
                            ...
                            <div class="row group">              
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" style="padding-top:22px;">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="text-align: center;">
                                                            ...
                                                            <div class="panel" style="height: 50%; width: 100%">
                                                                <button type="submit" class="btn btn-success btn-lg" name="PCBatchSave">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
                                        ...
                                        <a href="PCPenReq.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Pending Requests</a>          
                                    </div>
