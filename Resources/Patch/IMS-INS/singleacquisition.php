               ...
               // $rem = $_POST['a_remarks']; 
                ...
                // header("location: INSAcqDet.php");
                 ...
                 "<script type=\"text/javascript\">".
                  "alert
                  ('Your item is successfully added to the inventory!<br>
                    You will be redirected to the acquired items records');".
                 "</script>";
                 echo "<script>setTimeout(\"location.href = 'INSAcqDet.php';\",0);</script>";
