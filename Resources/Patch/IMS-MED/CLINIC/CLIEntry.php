                    ...
                    <ul class="active" >
                        ...
                        <li><a class="active" href="javascript:;"><i class="fa  fa-download"></i>Acquisition</a>
                            <ul class="active">
                                ...
                                <li><a class="active" href="CLIEntry.php">Entry Items</a></li>
                                    ...
                                    <tbody>
                                        <?php
                                           $view_query = mysqli_query($connection,
                                                           "SELECT *
                                                            FROM `ims_t_clinic_summary_request` AS SUMREQ  
                                        ...
                                        ?>      
                                                 <tr class="gradeX">
                                                        ...
                                                        <td style='width:150px'>
                                                                ...
                                                                <a href="CLIReviewAcquire.php?viewrequests=<?php echo $bn; ?>" class="btn btn-success">View</a>               
                                                                </center>
                                                       </td>
                                                </tr>  
                                 ...
                                 Acquisition of Items from different Modes  (Single Entry Form) 
                                  ...
                                  <div class="col-md-12">
                                                  <table class="display table table-bordered table-striped" style="width: 100%; ">                                
                                                                        <tr>
                                                                            <td>  
                                                                              <form role="form" method="POST" action="F_CLI_Acquisition.php">
                                                                                    ...
                                                                                    <div class="col-md-12" style="margin-bottom: 5px">
                                                                                        ...
                                                                                        function undisableTxt2() {
                                                                                           ...
                                                                                           <div class="col-md-12" style="background-color: #fff59d; border-style: solid; margin-right: 10px; ">
                                                                                            ...
                                                                                            <div class="col-md-7">
                                                                                                 <div class="form-group">
                                                                                                        <label for="exampleInputEmail1">Item Name</label>&nbsp
                                                                                                         <select id="ddCategory" name="a_oldselect" class="form-control" style="color: black;" required="" onchange="getCategory(this.value)" >
                                                                                                             <option value="" selected disabled></option>
                                                                                                                            <?php  
                                                                                                                                $sqlemp= "SELECT DISTINCT 
                                                                                                                                    Stock_Key_Unit, 
                                                                                                                                    Item_Name 
                                                                                                                                    FROM `ims_r_clinical_stock`";
                                                                                                                            ...
                                                                                                                            $sku = $row['Stock_Key_Unit'];
                                                                                                                             $Sname = $row['Item_Name'];
                                                                                                                            ?>
                                                                                                                                <option value="<?php echo $sku ?>"><?php echo "$Sname"; ?></option>
                                                                                                                            <?php 
                                                                                                                                } 
                                                                                                                            ?>
                                                                                                        </select>
                                                                                           ...
                                                                                           <div id="itemdiv" style="display: none">
                                                                                                <div class="form-group" style="display: none">
                                                                                                    <select id="ddItem" name="a_name" class="form-control" style="display: none">
                                                                                            ...
                                                                                            <div class="col-md-12" style="margin-bottom: 10px">
                                                                                                <button name="CLIEvaluateOLD" id="btnold" class="btn btn-warning"><i class="fa  fa-download"></i>  
                                                                                           ...
                                                                                           <div class="col-md-12" style="background-color: #69f0ae; border-style: solid;">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                               <div class="form-group">
                                                                                                    ...
                                                                                                    <input style="color: black;" disabled="disabled" type="text" name="a_new_sku" class="form-control" id="newsku"  maxlength="10"  />
                                                                                                </div>                                                        
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                             ...
                                                                                             <br>
                                                                                             <div class="col-md-12" style="margin-bottom: 10px">
                                                                                                 <button  name="CLIEvaluateNEW" disabled="disabled" id="btnnew" class="btn btn-success"><i class="fa  fa-download"></i>  
