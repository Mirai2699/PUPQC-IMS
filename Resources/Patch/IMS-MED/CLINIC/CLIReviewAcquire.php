                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                    ...
                                                                                                    <select name="a_old_sku" class="form-control" id="myText" style="color: black; margin-bottom: 87px;">
                                                                                                         <option value="" selected disabled></option>
                                                                                                                        ...
                                                                                                                        <?php  
                                                                                                                            $sqlemp= "SELECT DISTINCT Stock_Key_Unit, Item_Name FROM `ims_r_clinical_stock` AS MEDSTK INNER JOIN ims_t_clinic_requisition AS MEDREQ ON MEDSTK.Item_Category = MEDREQ.Item_Category

                                                                                                                            where MEDSTK.Item_Category  = MEDREQ.Item_Category";
                            ...
                            <!--<a data-toggle="modal" class="btn btn-success" href="DMPrintRequest.php?viewrequests=<?php echo $ids; ?>">View</a>-->
                                ...
                                <div class="col-md-12" style="text-align: right">
                                    <div class="form-group" style="padding-top:22px; text-align: right">
                                        ...
                                        &nbsp&nbsp
                                        <a href="CLIRelsReq.php" class="btn btn-default" style=" background-color: gray; padding-left: ">Go Back to Delivered Items</a>          
                                    </div>
                                </div>
