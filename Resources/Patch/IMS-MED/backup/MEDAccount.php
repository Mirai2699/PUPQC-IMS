            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="DPRevReq.php">For Revision</a></li> 
                ...
                <li>
                    ...
                    <ul class="sub">
                        <li><a href="DPEntRet.php">Entry Items</a></li>
                        <li><a href="DPForRet.php">Pending Returns</a></li>
                        <li><a href="DPRetDet.php">Returned</a></li>     
                        <hr>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub">
                        <!--<li><a href="DPTotalReq.php">Requisition</a></li>-->  
