...
<title>Setup Asset Library | PUPQC PSO</title>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    ...
                    <ul class="active" >
                        <li><a class="active" href="SAAssetlib.php"> Setup Asset Library</a></li>
...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <div class="row">
         ...
         <!--Add Campus-->
        <div class="panel">
             <form role="form" method="POST" action="F_AssetLibrary.php">
                <div class="heading" style="background-color:gray;  font-size: 15px; color: white">
                        <label style="margin: 10px">Add Asset Library</label>
                </div>
                <br>
                
                <div class="col-md-6">
                  <div class="form-group">
                      <label for="exampleInputEmail1">Asset Library Name</label>
                       <input style="color: black;" type="text" name="AL_Name"  maxlength="150" class="form-control"required/>
                  </div>
                </div>
                  <br>
                  <div class="col-md-12">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="text-align: center;">
                                                <div class="modal-header">
                                                    You are about to input a new Asset Library. Are you sure you want to proceed?
                                                </div>
                                                <img alt="" src="../Resources/images/PUP/analysis1.png" style="height: 20%; width: 20%">
                                                <div class="panel" style="height: 50%; width: 100%">
                                                    <button type="submit" class="btn btn-success btn-lg" name="AddAL">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
        ...
        <section id="content">
         <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                <div class="heading" style="background-color:gray; font-size: 15px; color: white">
                        <label style="margin: 10px">Manage Asset Libraries</label>
                </div>
                <form class="col s12">
                  ...
                  <div class="panel-body">
                    ...
                    <tbody>
                        <?php
                            $view_query = mysqli_query($connection,"SELECT * FROM `ams_r_asset_library` ");
                            while($row = mysqli_fetch_assoc($view_query))
                            	//ETO PALA UNG START NG LOOP HAHA, NASA DULO NG MODAL DIVISION UNG ISA PA
                                {
                                    ...
                                    $No = $row["AL_ID"];    // ETO YUNG ID NA DAPAT MONG IPASA SA PANGALAN NG MODAL
                                    $name = $row["AL_NAME"];
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form role="form" method="POST" action="F_AssetLibrary.php">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input style="display: none;" type="text" name="AL_ID" value="<?php echo $No; ?>" class="form-control"/>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Asset Library Name</label>
                                                                        <input style="color: black;" type="text" name="AL_Name" value="<?php echo $name; ?>" class="form-control" />
                                                                    </div>

                                                                   
                                                                    <br><hr>
                                                                   
                                                                    <button type="submit" class="btn btn-success" name="UpdateAL">Save</button>
                                                                    &nbsp&nbsp
