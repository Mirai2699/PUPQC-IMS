...
<title>Manage Office Supplies Category | PUPQC PSO</title>
                ...
                <li>
                    ...
                    <ul class="active" class="sub">
                            <li><a class="active" href="SAcategory.php">Setup Item Category</a>
                                <ul class="active">
                                    <li><a class="active" href="SA_Off_Category.php">------  Office Supplies</a></li>
    ...
    <section id="main-content">
        ...
        <section class="panel">
                    <header class="panel-heading">
                        Add Office Supply Category Type
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content" style="text-align: center;">
                                                                        ...
                                                                        <div class="panel" style="height: 50%; width: 100%">
                                                                            <button type="submit" class="btn btn-success btn-lg" name="addofficecat">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                          ...
                          <div class="panel-body">
                            ...
                            <tbody>
                                <?php
                                    $view_query = mysqli_query($connection,"SELECT * FROM `ims_r_office_category` WHERE DEF_Active = 1 ");
                                                         ...
                                                         <div class="modal-body">
                                                          <form action="F_Category.php" method="POST">
                                                                ...
                                                                <div class="form-content">
                                                                 ...
                                                                 <div class="panel" style="height: 50%; width: 100%">
                                                                    <button type="submit" class="btn btn-success " name="editofficecat"><i class="fa  fa-save"></i>   Save</button> &nbsp&nbsp&nbsp&nbsp
                                                                </div>
