                ...
                <li>
                    ...
                    <ul class="active" >
                            ...
                            <li><a class="active" href="javascript:;">Setup Items and Critical Level</a>
                                <ul class="active">
                                    <li><a class="active" href="SA_Supp_Office.php">------  Office Supplies</a></li>
            ...
            <div class="col-md-12">
             ...
             <section class="panel">
                    <header class="panel-heading">
                        Single Item Entry and Critical Level Modification Form for Office Supplies
                                ...
                                <tr>
                                    <td>     
                                     <form action="F_Supplies.php" method="POST">
                                            ...
                                            <?php  
                                                        $sqlemp= "SELECT DISTINCT Critical_level FROM `ims_r_office_stock`";
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content" style="text-align: center;">
                                                                                ...
                                                                                <div class="panel" style="height: 50%; width: 100%">
                                                                                    <button type="submit" class="btn btn-success btn-lg" name="OfficeChangeCrit">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
                                                ...
                                                <div class="row group">   
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input maxlength="150" type="text" name="a_sku" class="form-control" required="" style="color: black;"  />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="a_unit" class="form-control" style="color: black;" required="">
                                                                ...
                                                                <option value="Ream">Can</option>
                                                                <option value="Set">Bottle</option>
                                                        ...
                                                        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="Continue" class="modal fade">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content" style="text-align: center;">
                                                                        ...
                                                                        <img alt="" src="../Resources/images/PUP/analysis1.png" style="height: 20%; width: 20%">
                                                                        <div class="panel" style="height: 50%; width: 100%">
                                                                            <button type="submit" class="btn btn-success btn-lg" name="OFFICEINVinsert">   Yes   </button> &nbsp&nbsp&nbsp&nbsp
                                                                            <button data-dismiss="modal" class="btn btn-error btn-lg">No</button>
                                                                        </div>
                                                                        <br>
                                                                    </div>
